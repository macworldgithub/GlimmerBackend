...
export class OrderRepository {
    ...
    async get_all_store_orders(store: Types.ObjectId, page_no: number, projection?: OrderProjection) {
        const skip = (page_no - 1) * DEFAULT_DOCUMENTS_LIMITS;
    ...
    async get_store_monthly_sales(store: Types.ObjectId, month: number, year: number) {
