...
export class CustomerRepository {
    constructor(@InjectModel(Customer.name) private customer_model: Model<Customer>) { }
    ...
    async get_customer_by_id(_id: Types.ObjectId, projection?: CustomerProjection) {
    ...
    async update_customer(id: Types.ObjectId, customer_dto: UpdateCustomerDto) {
        ...
        return this.customer_model.findByIdAndUpdate(
            { _id: id },
            customer_dto,
