...
export class ProductService {
    ...
    async get_all_store_products(
        ...
        try {
            ...
            const total = await this.product_repository.get_total_no_products_by_store_id({ store: new Types.ObjectId(store_payload._id) })
    ...
    async get_total_no_products_by_store_id(
        ...
        try {
            const total = await this.product_repository.get_total_no_products_by_store_id({ store: new Types.ObjectId(store) })
            return total
        } catch (e) {
            console.log(e)
            throw new InternalServerErrorException(e)
